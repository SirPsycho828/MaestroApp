# MaestroApp — Implementation Kickoff

You are building **MaestroApp** from a complete PRD (Product Requirements Document) that has been decomposed into focused, implementation-ready files. This prompt is your guide to turning that PRD into a working application.
...
6. Read `docs/planning/05_Teacher_Onboarding.md`
7. Read `docs/planning/06_Student_Invitation.md`
8. Read `docs/planning/07_Availability_Management.md`
9. Read `docs/planning/08_Lesson_Scheduling.md`
10. Read `docs/planning/09_Lesson_Types_Locations.md`
11. Read `docs/planning/10_Group_Lessons.md`
12. Read `docs/planning/11_Credit_System.md`
13. Read `docs/planning/12_Stripe_Payments.md`
14. Read `docs/planning/13_Lesson_Workflow.md`
15. Read `docs/planning/14_Google_Calendar_Sync.md`
16. Read `docs/planning/15_Notifications.md`
17. Read `docs/planning/16_Teacher_Dashboard.md`
18. Read `docs/planning/17_Student_Dashboard.md`
19. Read `docs/planning/18_Future_Features.md`
...
- `docs/planning/05_Teacher_Onboarding.md`
- `docs/planning/06_Student_Invitation.md`
- `docs/planning/07_Availability_Management.md`
- `docs/planning/08_Lesson_Scheduling.md`
- `docs/planning/09_Lesson_Types_Locations.md`
- `docs/planning/10_Group_Lessons.md`
- `docs/planning/11_Credit_System.md`
- `docs/planning/12_Stripe_Payments.md`
- `docs/planning/13_Lesson_Workflow.md`
- `docs/planning/14_Google_Calendar_Sync.md`
- `docs/planning/15_Notifications.md`
- `docs/planning/16_Teacher_Dashboard.md`
- `docs/planning/17_Student_Dashboard.md`

**Deferred (skip for now):**
- `docs/planning/18_Future_Features.md`
...
Begin by reading `docs/planning/00_README.md`. Once you've read all 19 PRD files, set up the project and start building.
